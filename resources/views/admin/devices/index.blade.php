                    ...
                    @forelse ($devices as $device)
                        <tr data-id="{{ $device->id }}">
                            ...
                            <td>
                                ...
                                <form action="{{ route('devices.destroy', $device) }}" method="POST" class="d-inline delete-device-form">
                                    @csrf
                                    @method('DELETE')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#devices-table').on('click', '.edit-device-btn', function() {
                ...
                const url = "{{ route('devices.edit', ':id') }}".replace(':id', deviceId);
            ...
            $('#editDeviceForm').on('submit', function(e) {
                ...
                const url = "{{ route('devices.update', ':id') }}".replace(':id', deviceId);
