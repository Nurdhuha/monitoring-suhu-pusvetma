...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form id="chartFilterForm" action="{{ route('superadmin.data-suhu.index') }}" method="GET" class="mb-3">
                <div class="row">
                    <div class="col-md-5">
    ...
    <div class="modal fade" id="downloadExcelModal" tabindex="-1" role="dialog" aria-labelledby="downloadExcelModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="downloadExcelForm" action="{{ route('superadmin.data-suhu.download') }}" method="GET">
    ...
    <div class="modal fade" id="createDataSuhuModal" tabindex="-1" role="dialog" aria-labelledby="createDataSuhuModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="createDataSuhuForm" action="{{ route('superadmin.data-suhu.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-reading-btn').on('click', function() {
                ...
                const editUrl = '{{ route("superadmin.data-suhu.edit", ":id") }}'.replace(':id', readingId);

                $.get(editUrl, function(data) {
                    const updateUrl = '{{ route("superadmin.data-suhu.update", ":id") }}'.replace(':id', data.id);
